...
const General = () => {
    return (
        <div className={'aboutMe__general'}>
            <TitleComponent title={'About Me'} text={'I would describe myself as a highly productive individual who enjoys setting goals and achieving them. I value efficiency and work hard to get things done in a timely and effective manner. Even when faced with challenges or obstacles, I remain optimistic and maintain a positive outlook on life.'}/>
            <div className={'general__main'}>
                <img src={myPhoto} alt="It's me"/>
                <div className={'general__main-info'}>
                    <div>
                        <h2>Front-end Developer</h2>
                        <p>I come across as a highly productive, optimistic, friendly, and responsible individual who is always willing to learn and grow</p>
                    </div>
